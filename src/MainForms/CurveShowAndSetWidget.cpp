...
void CurveShowAndSetWidget::on_pushButton_11_clicked(bool checked)
{
    ...
    Business::getBusiness()->getModelTabWidget()->getCurrentCurveViewForm()->getViewFromWidget(m_currentIndex)->getMsigmaBase()->setAxisX(xMin,xMax);
}
/**
...
void CurveShowAndSetWidget::on_pushButton_12_clicked(bool checked)
{
    ...
    Business::getBusiness()->getModelTabWidget()->getCurrentCurveViewForm()->getViewFromWidget(m_currentIndex)->getMsigmaBase()->setAxisY(yMin,yMax);
}
/**
